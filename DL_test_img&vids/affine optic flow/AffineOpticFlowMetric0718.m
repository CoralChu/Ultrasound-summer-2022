...
Output:          1. end points series of a tracked fascicle;
                 2. pennation angle; (suitable for short videos becuase 
                 there's no correction; better under 7 seconds
                 3.(velocity? Don't know how exactly yet but should be ok
                 4.(this method CANNOT directly reliably measure length,
                 but can estimate from penn angle and apoenurosis distance
...
%Choosing points of high contrast can help
