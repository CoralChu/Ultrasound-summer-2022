...
Pending issue:   code is working but x and y notations are mixed up in here
...
while hasFrame(vidReader)
    ...
    plot([X1, X2], [Y1, Y2], '-o', 'LineWidth', 2, 'MarkerSize', 7, 'Color', 'b');
...
Result_penn_angles = run./rise; %pending issue: have to write this cuz xy are mixed up
