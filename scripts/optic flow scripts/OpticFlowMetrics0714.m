...
%{
Purpose:         extract optic flow metrics from ultrasound videos using
...
vidReader = VideoReader('Jme_low.avi', 'CurrentTime', 0);
...
while hasFrame(vidReader)
    ...
    %newly added: cropping
    frameGray = frameGray(mask(3):mask(4),mask(1):mask(2));
    ...
    %option 2: visualize orientation; adjust pause to 10^-2
